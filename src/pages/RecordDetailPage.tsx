...
export function RecordDetailPage() {
  ...
  return <PageContainer className="max-w-3xl"><div className="mb-5 flex items-center justify-between"><Link to="/records" className="text-sm font-bold text-slate-500">← 기록 목록</Link><Link to={`/records/${record.id}/edit`} className="flex items-center gap-1 text-sm font-bold text-slate-500 hover:text-team"><Pencil className="h-4 w-4" />수정</Link></div>
